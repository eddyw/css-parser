...
import type { SyntaxTokenizerContext, CSSShutCurlyBrace } from '~/shared/types'

export function consumeShutCurlyBrace(x: SyntaxTokenizerContext): Readonly<CSSShutCurlyBrace> {
	return {
