...
export const BLOCK_MIRROR = {
	[NODE_SYMB.OPEN_CURLY_BRACE_TOKEN]: NODE_SYMB.SHUT_CURLY_BRACE_TOKEN,
	[NODE_SYMB.OPEN_PARENTHESIS_TOKEN]: NODE_SYMB.SHUT_PARENTHESIS_TOKEN,
	[NODE_SYMB.OPEN_SQUARE_BRACKET_TOKEN]: NODE_SYMB.SHUT_SQUARE_BRACKET_TOKEN,
}
